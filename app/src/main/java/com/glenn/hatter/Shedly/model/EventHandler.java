...
public class EventHandler {
    ...
    public EventHandler(Context context, Calendar calendar, ArrayList<Event> list,ArrayList<Event> replaceList,ArrayList<Event> removedEvents,ArrayList<Event> binedFixedEvents) {
        mCalendar = calendar;
        mContext = context;
        mEvent.addAll(list);
        mReplaceList.addAll(replaceList);
        mRemovedEvents.addAll(removedEvents);
        mBinedFixedEvents.addAll(binedFixedEvents);
    }
